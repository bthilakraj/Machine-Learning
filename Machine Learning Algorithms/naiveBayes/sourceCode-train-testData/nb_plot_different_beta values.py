...
def main():
    ...
    accuracypercentage=[]
    ivalue=[]
    while(i<=1):#WHILE LOOP TO CALCULATE FOR DIFFERENT BETA VALUES RANGING FROM 0.00001 TO 1
        acc=nb(i)
        i=i+0.010000
        print "Accuracy in main",acc
        accuracypercentage.append(acc)
        ivalue.append(i)
    print accuracypercentage
    print ivalue
    plt.semilogx(ivalue,accuracypercentage)
    plt.show()
